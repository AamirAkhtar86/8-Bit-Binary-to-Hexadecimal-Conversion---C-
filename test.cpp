...
{
    string rest("0x"),tmp,chr = "00000000";
    //int len = sBinary.length()/8;
    int len = 0;
    chr = chr.substr(0,len);
    sBinary = chr+sBinary;
    cout << len << endl;
    cout << chr << endl;
    cout << sBinary.length() << endl;
...
int main()
{
    string bin = GetHexFromBin("11011110101011011011010011011110");
    cout << bin.erase(0,2) << endl;
}